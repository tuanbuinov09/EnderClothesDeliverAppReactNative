...
//     useEffect(() => {
//         if (SyncStorage.getItem('user') && props.type === 'customer') {
//             navigate('/user/info', { replace: true });
//         }
//         if (SyncStorage.getItem('employee') && props.type === 'employee') {
...
//             SyncStorage.removeItem('employee');
...
//                     setErrorMessage('');
//                     SyncStorage.setItem('user', JSON.stringify(userInfoFromRes));
//                     console.log('---', SyncStorage.getItem('user'));
//                     axios
//                         .get(
//                             `http://localhost:22081/api/KhachHang/favorite?customerId=${userInfoFromRes.MA_KH}`,
//                         )
//                         .then(respListFavorite => {
...
//                     setErrorMessage('');
//                     SyncStorage.setItem('employee', JSON.stringify(userInfoFromRes));
//                     console.log('---', SyncStorage.getItem('employee'));
//                     if (JSON.parse(SyncStorage.getItem('employee')).MA_QUYEN === 'Q04') {
...
//                                 {props.type === 'customer' ? (
//                                     <p
//                                         className={clsx(style.signUpLink)}
//                                         onClick={() => {
